...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
	...
	#	primary.dom_class = 'nav'
   	# 	primary.item :tasks, 'Add new', new_task_path#, :icon => ['icon-book', :'icon-white']
    #	primary.item :tasks, 'Done tasks', tasks_path
    #	primary.item :tasks, 'All tasks',  tasks_path
  	#end
  ...
  navigation.items do |primary|
	...
	#primary.item :domain, 'Pets', :class => 'nav'
